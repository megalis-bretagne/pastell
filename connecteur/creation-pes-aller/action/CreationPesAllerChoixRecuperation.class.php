...
class CreationPesAllerChoixRecuperation extends ChoiceActionExecutor {
    ...
    public function display(){
        ...
        $this->renderPage("Choix d'un connecteur", $this->objectInstancier->{'pastell_path'}."/connecteur/creation-document/template/CreationDocumentChoixConnecteur.php");
        return true;
    }
