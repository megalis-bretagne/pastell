...
class smbclient
{
            ...
            if ($this->put ($local_filename, $remote_filename))
            {
                ...
                if ($this->get ($remote_filename, $tmp_local_filename))
                {
                    ...
                    else
                    {
                        ...
                        array_unshift ($this->_last_cmd_stderr, "safe_put() failed to validate checksum of ...");
    ...
    public function dir ($remote_path = '', $remote_filename = '')
    {
        ...
        foreach ($this->_last_cmd_stdout as $line)
        {
            ...
            list (/** @noinspection PhpUnusedLocalVariableInspection */ $junk, $filename, $status, $size, $mtime) = $matches;
