...
class Nomemclature extends ChoiceActionExecutor {
	...
	public function display(){
		...
		$this->renderPage("Choix du type d'Actes",__DIR__."/../template/NomemclatureList.php");
	}
	
	private function getNomemclatureContent(){
		$id_e_cdg = $this->getEntiteSQL()->getCDG($this->id_e);
		if (! $id_e_cdg){
			return false;
		}
		...
		$donneesFormulaireCDG = $this->getConnecteurFactory()->getConnecteurConfigByType($id_e_cdg,'actes-cdg','classification-cdg');
