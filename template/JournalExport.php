	...
	<table class='table table-striped'>
			...
			Date de début
			 ...
			 <td>
                 <div class="input-group">
                     <input type='text' id='date_debut' class="col-md-3 form-control box-input" name='date_debut' value='<?php hecho(date_iso_to_fr($date_debut))?>'/>
		...
		<tr>
			...
			Date de fin
			 ...
			 <td>
                 <div class="input-group">
                     <input type='text' id='date_fin' class="col-md-3 form-control box-input" name='date_fin' value='<?php hecho(date_iso_to_fr($date_fin))?>' />
                     <div class="input-group-append">
                         <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                     </div>
                 </div>
