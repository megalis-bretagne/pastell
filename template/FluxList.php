...
<?php if($id_e_mere) : ?>
	<form action='flux/toogle-heritage.php' method='post' >
	...
	<tr>
		...
		<td>
			<?php if ($connecteur_info['connecteur_info']) : ?>
				...
				<a href='connecteur/edition.php?id_ce=<?php echo $connecteur_info['connecteur_info']['id_ce'] ?>'><?php hecho($connecteur_info['connecteur_info']['libelle']) ?></a>
		...
		<td>
			<?php if ($connecteur_info['connecteur_info']) : ?>
				<?php if ($connecteur_info['connecteur_info']['id_e'] != $id_e) : ?>
					<em> de <a href='entite/detail.php?id_e=<?php echo $connecteur_info['connecteur_info']['id_e'];?>'><?php echo $connecteur_info['connecteur_info']['denomination']; ?></a></em>
				<?php endif;?>
			<?php endif;?>
		&nbsp;
		</td>
		<td>
			<?php if(! $connecteur_info['inherited_flux'] && ! $all_herited) :?> 
				<a class='btn btn-mini' href='flux/edition.php?id_e=<?php echo $id_e?>&flux=<?php hecho($connecteur_info['id_flux'])?>&type=<?php echo $connecteur_info['connecteur_type'] ?>'>Choisir un connecteur</a>
			<?php endif;?>
		</td>
	</tr>
<?php endforeach;?>
